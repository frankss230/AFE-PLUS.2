...
import { updateCaregiver } from "@/actions/caregiver.actions";
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 max-w-4xl">
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <Input {...form.register('phone')} placeholder="กรอกเบอร์โทรศัพท์" />
          </div>
          <div className="space-y-1">
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <Label>สิทธิ์การใช้งาน<span className="text-xs text-gray-400 font-normal">(แก้ไขไม่ได้)</span></Label>
