                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input type="tel" maxLength={10} {...form.register('phone')} className="w-full pl-12 pr-4 py-3 bg-slate-50 rounded-2xl border-0 focus:ring-2 focus:ring-blue-500/20 transition-all font-bold text-slate-700 tracking-wide placeholder:text-slate-300" placeholder="กรอกเบอร์โทรศัพท์" />
                            </div>
